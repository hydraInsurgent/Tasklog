...
export function registerProjectTools(server: McpServer): void {
  server.registerTool(
    'list_projects',
    {
      title: 'List Projects',
      description:
        'List all projects in Tasklog. Returns each project with id, name, ' +
        'and createdAt. Use to find project ids before assigning tasks.',
    },
  ...
  server.registerTool(
    'rename_project',
    {
      ...
      description: 'Change a project\'s name. Tasks within the project are not affected.',
      inputSchema: {
