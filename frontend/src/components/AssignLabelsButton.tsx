    ...
    <div className="flex flex-col items-end gap-2">
      ...
      {availableLabels.length > 0 && (
        <select
          ...
          className="text-sm px-2 py-1 border border-border rounded-md text-text-muted focus:outline-none focus:ring-2 focus:ring-accent disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer bg-surface transition-shadow duration-150"
        >
